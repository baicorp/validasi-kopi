...
DROP INDEX "user_nik_unique";--> statement-breakpoint
...
ALTER TABLE `user` ALTER COLUMN "nik" TO "nik" text NOT NULL;--> statement-breakpoint
CREATE UNIQUE INDEX `session_token_unique` ON `session` (`token`);--> statement-breakpoint
CREATE UNIQUE INDEX `user_email_unique` ON `user` (`email`);--> statement-breakpoint
CREATE UNIQUE INDEX `user_username_unique` ON `user` (`username`);--> statement-breakpoint
CREATE UNIQUE INDEX `user_nik_unique` ON `user` (`nik`);--> statement-breakpoint
...
ALTER TABLE `user` ALTER COLUMN "position" TO "position" text NOT NULL;